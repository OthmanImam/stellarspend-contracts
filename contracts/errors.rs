use soroban_sdk::{contracttype, String, Vec, Map, Env};
...
impl ErrorDocumentation {
    ...
    fn error_description(error: &StellarSpendError) -> String {
        match error {
            ...
            StellarSpendError::InvalidInitialization => "Invalid initialization parameters provided".into(),
            StellarSpendError::Unauthorized => "Caller is not authorized to perform this operation".into(),
            StellarSpendError::InvalidSignature => "Provided signature is invalid".into(),
            StellarSpendError::InsufficientPermissions => "Insufficient permissions for this operation".into(),
            StellarSpendError::AdminRequired => "Admin privileges required for this operation".into(),
            StellarSpendError::MinterRequired => "Minter privileges required for this operation".into(),
            ...
            StellarSpendError::InvalidState => "Contract is in invalid state for this operation".into(),
            ...
            StellarSpendError::InsufficientBalance => "Insufficient balance for this operation".into(),
            StellarSpendError::InsufficientAllowance => "Insufficient allowance for this operation".into(),
